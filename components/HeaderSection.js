            ...
            <div className="container mx-auto px-4 md:px-[30px]">
                <div className="md:text-left text-center mb-8 md:mb-12">
                    ...
                    <div className="flex justify-center md:justify-start">
                        <button className="mt-6 md:mt-8 px-6 py-3 md:px-8 md:py-4 border-1 hover:border-2 text-white text-base md:text-xl rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center">
