...
const Form = ({ onClose }) => {
  ...
  return (
    <div className="max-w-xl mx-auto mt-10 p-10 rounded-[30px] shadow-md bg-gradient-to-br from-[#F4F1AA]/50 to-[#E5BC7E] relative">
      <button
        className="absolute top-6 right-6 w-10 h-10 flex items-center justify-center bg-transparent rounded-full hover:cursor-pointer"
        onClick={onClose}
      >
        <svg
      ...
      <p className="text-4xl mb-4 mt-3">Get free sample report & white paper</p>
      {successMessage && (
